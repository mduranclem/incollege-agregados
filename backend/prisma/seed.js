...
async function main() {
  ...
  const pedido1 = await prisma.pedido.create({
    data: {
      ...
      numeroContrato: 'CSM-2026-001',
      costoTotal: 45000,
      sena: 15000,
      fechaEntregaComprometida: new Date('2026-11-30'),
        ...
        create: [
          {
            ...
            etapas: {
              create: buildEtapas(true, false).map((e, i) => ({
                ...e,
                completada: i < 2,
                fechaInicio: i < 2 ? new Date('2026-10-01') : null,
                fechaFin: i < 2 ? new Date('2026-10-05') : null,
          ...
          },
          {
            ...
            etapas: {
              create: buildEtapas(true, true).map((e, i) => ({
                ...e,
                completada: i < 1,
                fechaInicio: i < 1 ? new Date('2026-10-01') : null,
                fechaFin: i < 1 ? new Date('2026-10-03') : null,
  ...
  await prisma.pedido.create({
    data: {
      ...
      numeroContrato: 'IN-2026-042',
      costoTotal: 38000,
      sena: 10000,
      fechaEntregaComprometida: new Date('2026-12-15'),
  ...
  const pedido3 = await prisma.pedido.create({
    data: {
      ...
      numeroContrato: 'CDS-2026-017',
      costoTotal: 52000,
      sena: 20000,
      fechaEntregaComprometida: new Date('2026-10-20'),
      localTomoPedido: 'SUR',
  ...
  await prisma.pedido.create({
    data: {
      ...
      numeroContrato: 'EB-2026-005',
      costoTotal: 41000,
      sena: 41000,
      fechaEntregaComprometida: new Date('2026-09-01'),
  ...
  await prisma.pedido.create({
    data: {
      ...
      numeroContrato: 'CP-2026-099',
      costoTotal: 35000,
      sena: 5000,
      fechaEntregaComprometida: new Date('2026-11-01'),
